...
namespace Repositories.Config
{
    public class ProductConfig:IEntityTypeConfiguration<Product>{
        public void Configure(EntityTypeBuilder<Product> builder){
            ...
            new Product() { ProductId = 3, CategoryId = 2, ImageUrl="/images/3.jpg", ShowCase=true, ProductName = "Monitor", Price = 5_000 },
            new Product() { ProductId = 4, CategoryId = 2, ImageUrl="/images/4.jpg",ShowCase=true,  ProductName = "Mouse", Price = 1_000 },
            ...
            new Product() { ProductId = 7, CategoryId = 1, ImageUrl="/images/7.jpg",ShowCase=true,  ProductName = "Hamlet", Price = 150 },
